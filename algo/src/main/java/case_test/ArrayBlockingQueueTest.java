...
public class ArrayBlockingQueueTest<E> extends AbstractQueue<E>
    ...
    public static void main(String[] args) throws InterruptedException {
        ArrayBlockingQueueTest<Integer> arrayBlockingQueue = new ArrayBlockingQueueTest<>(100);
        for (int i = 0; i < 100; i++) {
            arrayBlockingQueue.put(i);
//            System.out.println(arrayBlockingQueue.count);
//            System.out.println(arrayBlockingQueue.putIndex);
//            System.out.println(arrayBlockingQueue.takeIndex);
        }
...
//            System.out.println(arrayBlockingQueue.takeIndex);
    ...
    /**
     * Creates an {@code ArrayBlockingQueueTest} with the given (fixed)
    ...
    public Iterator<E> iterator() {
        return new ArrayBlockingQueueTest.Itr();
    }
    ...
    /**
     * Iterator for ArrayBlockingQueueTest.
     *
        ...
        Itr() {
            ...
            try {
                if (count == 0) {
                    ...
                    final int takeIndex = ArrayBlockingQueueTest.this.takeIndex;
