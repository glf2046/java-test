...
public class ReflectionTest3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            // 获得类对象
            Class<?> c = Class.forName("com.lefeng.test.syntax.Toy");
            printInfo("获得类对象", c);

            //get setter method for 'id' field
            Method method1 = c.getMethod("setId", byte.class);
            Toy toy = new Toy();
            //'11' is int type, conversion from int to byte will cause an error, down-casting error.
            method1.invoke(toy, new Object[]{11});
